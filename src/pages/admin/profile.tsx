...
export default function ProfilePage() {
  ...
  return (
    <>
      <SEO title="Hồ sơ shop — Admin" />
      <AdminLayout title="Hồ sơ shop" shopName={shop.name}>
        <form onSubmit={handleSave} className="max-w-3xl space-y-6">
          <div className="rounded-2xl bg-card border border-border/50 p-6">
            ...
            <p className="text-xs text-muted-foreground mb-5">Logo và banner sẽ hiển thị trên trang storefront</p>

            <div className="space-y-5">
              <div>
                <Label className="text-sm font-semibold mb-2 block">Banner cửa hàng</Label>
                <div className="relative aspect-[3/1] rounded-xl overflow-hidden border-2 border-dashed border-border bg-muted group">
                  ...
                  <label className="absolute inset-0 flex items-center justify-center bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
                    <span className="bg-white text-foreground px-4 py-2 rounded-xl text-sm font-medium">Đổi banner</span>
          ...
          <div className="rounded-2xl bg-card border border-border/50 p-6">
            ...
            <p className="text-xs text-muted-foreground mb-5">Thông tin giới thiệu hiển thị trên trang storefront</p>

            <div className="space-y-4">
              <div>
                <Label className="text-sm font-semibold">Tên cửa hàng</Label>
          ...
          <div className="rounded-2xl bg-card border border-border/50 p-6">
            ...
            <p className="text-xs text-muted-foreground mb-5">Màu chủ đạo áp dụng cho storefront — nút bấm, link, badge...</p>
          ...
          <div className="rounded-2xl bg-card border border-border/50 p-6">
            ...
            <p className="text-xs text-muted-foreground mb-5">Khách hàng sẽ thấy thông tin này ở footer storefront</p>

            <div className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <Label className="flex items-center gap-1.5 text-sm font-semibold"><Phone className="w-3.5 h-3.5" />Số điện thoại</Label>
              ...
              <div>
                <Label className="flex items-center gap-1.5 text-sm font-semibold"><MapPin className="w-3.5 h-3.5" />Địa chỉ</Label>
          ...
          <div className="sticky bottom-4 z-10">
            <div className="rounded-2xl bg-card border border-border shadow-lg p-3 flex items-center justify-between gap-3">
              <p className="text-sm text-muted-foreground pl-2">{saved ? "✓ Đã lưu thành công" : "Nhớ lưu thay đổi sau khi chỉnh sửa"}</p>
